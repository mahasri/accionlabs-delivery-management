...
<div class="genai-focus-areas">
    ...
    <div class="focus-area-card">
        <div class="breeze-badge">
            <span class="breeze-icon">⚡</span>
            <span class="breeze-text">powered by Breeze.ai</span>
        </div>
...
<div class="metrics-dashboard">
    <div class="metrics-container">
        ...
        <div class="metric-card">
            ...
            <div class="metric-label">Business Value Use Cases</div>
            <div class="metric-source">Source: Business case analysis</div>
        </div>
        
        <div class="metric-card">
            <div class="metric-value">30</div>
            <div class="metric-label">GenAI Tools in Use</div>
            <div class="metric-source">Source: Tool adoption metrics</div>
        </div>
        
        <div class="metric-card">
            <div class="metric-value">2125</div>
            <div class="metric-label">GenAI Trained</div>
            <div class="metric-source">Source: Training program records</div>
        </div>
    </div>
</div>
...
<div class="tools-portfolio-section">
...
<div class="use-cases-container">
    <div>
        ...
        <div class="use-case-category">
            ...
            <div class="use-case-item">
                <div class="use-case-text">Self-assisted customer support</div>
        ...
        <div class="use-case-category">
            ...
            <div class="use-case-item">
                <div class="use-case-text">Legacy code migration</div>
                <div class="project-count">2</div>
            </div>
        </div>
    </div>
    ...
    <div class="clients-section">
        ...
        <div class="clients-grid">
            ...
            <div class="client-item">Parent Pay</div>
            <div class="client-item">Fish Bowl</div>
        </div>
    </div>
</div>
...
<div class="reports-carousel">
    ...
    <div class="carousel-controls">
        ...
        <div class="carousel-dots">
            ...
            <span class="dot" onclick="currentSlide(4)" title="Report 4"></span>
            <span class="dot" onclick="currentSlide(5)" title="Report 5"></span>
            <span class="dot" onclick="currentSlide(6)" title="Report 6"></span>
            <span class="dot" onclick="currentSlide(7)" title="Report 7"></span>
        </div>
...
<style>
/* Restore RHS table of contents for this page */
